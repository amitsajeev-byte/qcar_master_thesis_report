...
\newcommand{\thesisDegree}{Master of Engineering} % TODO: confirm exact degree title (M.Eng./M.Sc./...) with the Centre for Studies
\newcommand{\thesisProgramme}{Artificial Intelligence for Smart Sensors / Actuators}
...
\input{frontmatter/authorship}         % Statement of Authorship - no page number, per 4.1.4
\clearpage

% \input{frontmatter/acknowledgement}  % TODO: optional, uncomment if you want one (guideline 4.1.3)
...
\input{frontmatter/abbreviations}       % per guideline 4.1.5
\clearpage

...
\input{frontmatter/authorship}         % Declaration - mandatory per abschlussarbeit_anmeldung_master_mss_en.pdf, bound directly after title page, no page number
\clearpage

\input{frontmatter/ai_declaration}     % Declaration Concerning Usage of AI - separate page, no page number
\clearpage

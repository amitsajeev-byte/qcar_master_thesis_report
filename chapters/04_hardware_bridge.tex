...
plugin. This requires no awareness that the underlying vehicle is
reached over a bespoke protocol rather than a co-located
Gazebo simulation.
...
The first real navigation-goal test, run once mapping,
...
motor bridge was still listening on its TCP port after it was
believed to have been stopped. The documented procedure therefore

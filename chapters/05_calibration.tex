...
never has an opportunity to drain. My own reading of this design is
that \texttt{readMode=1} exists mainly as a debugging convenience
within the QCar HAL: a background task a developer can poll without
managing acquisition timing directly. It does not read like a mode
...
physical argument that prompted reading QCar's
